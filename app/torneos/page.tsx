    ...
    <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${sc ? 'bg-background/85 backdrop-blur-2xl border-b border-foreground/5 shadow-lg shadow-scrim/40' : ''}`}>
      <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link href={`${APP}/login`} className="text-muted-foreground hover:text-foreground text-sm px-3 py-1.5 transition-colors">
            Ingresar
          </Link>
          <Link
            href={`${APP}/register`}
...
function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-5 pt-16 overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[300px] rounded-full blur-[120px] pointer-events-none" style={{ background: `hsl(var(--primary) / 0.094)` }} />
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <h1 className="text-5xl sm:text-7xl lg:text-[82px] font-black leading-[.92] mb-6 tracking-tight drop-shadow-2xl">
          ...
          <span className="block text-foreground">Ascendé.</span>
        </h1>
      ...
      <a href="#formatos" className="absolute bottom-8 inset-x-0 flex flex-col items-center gap-1 text-foreground/40 hover:text-foreground/60 transition-colors" style={{ animation: 'bounce 2s infinite' }}>
...
function Formatos() {
  return (
    <section id="formatos" className="py-24 px-5 bg-background">
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-5">
          ...
          <Reveal from="left">
            <div className="bg-card border border-border rounded-3xl p-8 hover:border-border-strong transition-colors h-full">
              <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-5" style={{ background: `hsl(var(--primary) / 0.125)` }}>
                <Trophy size={24} style={{ color: GREEN }} />
              </div>
              <div className="flex items-center gap-3 mb-3">
                <h3 className="text-xl font-bold text-foreground">3 Sets · Eliminación</h3>
                <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-full" style={{ background: `hsl(var(--primary) / 0.145)`, color: GREEN }}>Más puntos</span>
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <Reveal from="right" delay={100}>
            <div className="space-y-3">
              <div className="bg-card border border-border-strong rounded-3xl p-6">
                <div className="flex items-center gap-2 mb-4">
                  <Trophy size={16} style={{ color: GREEN }} />
                  <p className="font-bold text-foreground">Copa Primavera · 6ta Caballeros</p>
                </div>
...
function Ranking() {
  ...
  return (
    <section id="ranking" className="py-24 px-5 bg-background">
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Mock */}
          <Reveal from="left">
            <div className="space-y-3">
              <div className="bg-card border border-border rounded-3xl p-6">
                ...
                <div className="flex gap-2 mb-4 flex-wrap">
                  {['General', '6ta', 'Club BsAs'].map((f, i) => (
                    <span key={f} className="text-[11px] font-bold px-3 py-1 rounded-full" style={i === 0 ? { background: GREEN, color: 'hsl(var(--primary-foreground))' } : { background: 'hsl(var(--surface-2))', color: 'hsl(var(--muted-foreground) / 0.7)' }}>{f}</span>
                  ))}
                </div>
              ...
              <div className="flex items-center gap-3 bg-card border border-border rounded-2xl p-4">
                ...
                <p className="text-xs text-muted-foreground">Los puntos son <strong className="text-foreground">por jugador</strong>, no por pareja. Cada uno acumula sus puntos individualmente.</p>
              </div>
            </div>
          </Reveal>
    ...
    <section className="relative py-24 px-5 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="relative mb-12">
          <div className="absolute top-6 left-0 right-0 h-px hidden md:block" style={{ background: `hsl(var(--primary) / 0.125)` }} />
            ...
            {[
              ...
              <Reveal key={n} delay={n * 80}>
                <div className={`flex flex-col items-center text-center ${done ? '' : 'opacity-35'}`}>
                  ...
                  <p className="text-xs font-bold text-foreground">Fecha {n}</p>
                  <p className="text-[10px] text-muted-foreground/70">{mes}</p>
                  {done && pts && (
                    <>
...
function Categorias() {
  ...
  return (
    <section id="categorias" className="py-24 px-5 bg-background">
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <Reveal from="left">
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                De 9na (principiante) a 1ra (élite). Dentro de cada categoría tenés un <strong className="text-foreground">rating decimal</strong> que muestra exactamente qué tan cerca estás de ascender.
              </p>

              {/* Rating bar */}
              <div className="bg-card border border-border rounded-2xl p-5 mb-6">
                <p className="text-xs font-bold text-muted-foreground/70 uppercase tracking-widest mb-4">Ejemplo · 6ta categoría</p>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={rating} className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] text-muted-foreground/70 w-32 text-right">{label}</span>
                    </div>
                  ))}
                </div>
                <p className="text-[10px] text-muted-foreground/50 mt-3">← Menor número = más cerca de ascender</p>
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-between bg-card border border-border rounded-xl px-4 py-3 text-sm text-muted-foreground hover:text-foreground hover:border-border-strong transition-colors"
              >
                <span>¿Cómo me asignan la categoría inicial?</span>
                {faqOpen ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
              </button>
              {faqOpen && (
                <div className="bg-card/70 border border-border border-t-0 rounded-b-xl px-4 py-3 text-sm text-muted-foreground leading-relaxed -mt-px">
          ...
          <Reveal from="right" delay={100}>
            <div className="bg-card border border-border rounded-3xl p-6">
              <p className="text-xs font-bold text-muted-foreground/70 uppercase tracking-widest mb-5">Escala completa de categorías</p>
              ...
              <div className="flex justify-between text-[10px] text-muted-foreground/50 mt-3 px-1">
  ...
  return (
    <section className="relative py-24 px-5 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        {/* Visual */}
        <Reveal>
          <div className="rounded-3xl p-8 md:p-12" style={{ background: `hsl(var(--primary) / 0.031)`, border: `1px solid hsl(var(--primary) / 0.145)` }}>
              ...
              <div className="space-y-2.5 md:ml-8">
                {[
                  ...
                  <div key={t} className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-foreground-subtle">{t}</span>
                  </div>
                ))}
              </div>
            </div>
  ...
  return (
    <section id="clubes" className="relative py-24 px-5 overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-background/70" />
      </div>
      <div className="relative max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <Reveal from="left">
            <div>
              ...
              <p className="text-foreground-subtle text-lg mb-8 leading-relaxed">
              ...
              <div className="space-y-3 mb-8">
                {[
                  ...
                  <div key={t} className="flex gap-3 p-3.5 bg-foreground/5 backdrop-blur border border-foreground/10 rounded-xl hover:bg-foreground/10 hover:border-foreground/20 transition-all">
...
function CTA() {
  return (
    <section className="relative py-36 px-5 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] rounded-full blur-[100px] pointer-events-none" style={{ background: `hsl(var(--primary) / 0.071)` }} />
    ...
    <footer className="border-t border-border bg-background px-5 py-14">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <h4 className="text-foreground font-bold text-xs mb-4 uppercase tracking-[.15em]">Torneos</h4>
            <div className="space-y-2.5 text-sm text-muted-foreground">
              <a href="#formatos" className="block hover:text-foreground transition-colors">Formatos</a>
              <a href="#ranking" className="block hover:text-foreground transition-colors">Ranking</a>
              <a href="#categorias" className="block hover:text-foreground transition-colors">Categorías</a>
              <a href="#clubes" className="block hover:text-foreground transition-colors">Para clubes</a>
            </div>
          </div>
          <div>
            <h4 className="text-foreground font-bold text-xs mb-4 uppercase tracking-[.15em]">App</h4>
            <div className="space-y-2.5 text-sm text-muted-foreground">
              <Link href={`${APP}/register`} className="block hover:text-foreground transition-colors">Crear cuenta</Link>
              <Link href={`${APP}/login`} className="block hover:text-foreground transition-colors">Ingresar</Link>
              <Link href="/" className="block hover:text-foreground transition-colors">Inicio</Link>
              <a href="https://wa.me/5492324549325" target="_blank" rel="noopener noreferrer" className="block hover:text-foreground transition-colors">WhatsApp</a>
            </div>
          </div>
        </div>
